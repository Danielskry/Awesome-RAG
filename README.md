...
- [markdex](https://github.com/incu6us/markdex): Self-hosted Go knowledge base that ingests Markdown into Qdrant with heading-aware chunking, hybrid dense+sparse search and cross-encoder reranking (REST + MCP).
