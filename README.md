...
- [Zoom Search](https://github.com/goofrey/zoom-search): Agentic search tool for evidence-grounded RAG workflows with query rewriting, domain zoom-in, and sourced answers.
