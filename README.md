...
- [Legal Document Chat](https://github.com/janderswag/legal-document-chat): Self-hosted RAG application for chatting with legal PDFs using local Ollama models, with character-level citation verification (page/span); runs fully offline (FastAPI + LanceDB, MIT).
