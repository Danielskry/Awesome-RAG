...
- **[ragfresh](https://github.com/nac7/ragfresh)**: Open-source CLI that detects stale, drifted, and ghost documents in RAG vector indexes by diffing content hashes and embedding drift against the source of truth.
