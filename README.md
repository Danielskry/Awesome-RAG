...
- **[rageval-ai](https://github.com/CYBki/llm-evaluation)**: Lightweight LLM-as-judge evaluation library for RAG, including hallucination detection, faithfulness, and answer relevancy, with local or self-hosted deployment.
