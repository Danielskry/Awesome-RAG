...
- **[rag-guard](https://github.com/Jott2121/rag-guard)**: Guarded RAG with a built-in eval harness — refuses when retrieval does not support the answer, checks groundedness, redacts PII, and reports refusal/grounding accuracy on a published run. Stdlib core.
