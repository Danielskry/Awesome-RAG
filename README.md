...
- [khazad](https://github.com/GuglielmoCerri/khazad): Transparent semantic cache for LLM API calls, powered by Redis Vector Sets. Cuts cost and latency by returning cached responses for semantically similar queries.
