...
- [Heym](https://github.com/heymrun/heym): Source-available, self-hosted AI workflow automation platform for building agent, RAG, and tool-using workflows on a visual canvas.
