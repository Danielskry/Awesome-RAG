...
- [AutoGraft](https://github.com/jules-gd-dev/autograft-lib): A middleware for Neo4j GraphRAG that keeps LLM entity resolution to ~0.2% of entities using a deterministic -> vector -> LLM cascade.
