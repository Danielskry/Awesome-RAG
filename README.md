...
- [Hybrid RAG Action](https://github.com/Cagrik34/hybrid-rag-action): Zero-dependency GitHub Action for automated repository triage combining Okapi BM25 and dense semantic embeddings with RRF.
