...
- [BlazeDocs](https://blazedocs.io): PDF-to-Markdown conversion service (API, CLI, and web) that turns scanned PDFs, tables, and forms into clean Markdown for RAG ingestion pipelines.
