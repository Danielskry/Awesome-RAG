...
- **[zer0lint](https://github.com/hermes-labs-ai/zer0lint)**: Memory-extraction health diagnostic for mem0 configs and HTTP memory endpoints. Flags silent failure modes where ingestion reports success but facts never survive the LLM extraction step, then generates a stronger extraction prompt validated on your own model.
