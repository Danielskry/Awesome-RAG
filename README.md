...
- [TranscriptBatch](https://transcriptapiyt.com/youtube-transcript-api): bulk YouTube playlist to RAG-ready JSON transcripts with timestamps, language, and per-video status. 300 videos per playlist job through a REST API; 20 free transcripts monthly.
