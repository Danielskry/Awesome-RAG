...
- **[Future AGI](https://github.com/future-agi/future-agi)**: Open-source platform for simulation, evaluating, tracing, guarding, and auto-improving RAG and AI agent apps.
