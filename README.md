...
- [FutureSearch SDK](https://github.com/futuresearch/futuresearch-python) - AI-powered data cleaning for RAG pipelines. Deduplicate documents, resolve entities, and filter content before indexing.
