...
- [Viglet Turing ES](https://github.com/openviglet/turing-ce): Open-source enterprise-search platform (Java/Spring Boot) with faceted and hybrid (RRF) retrieval over a pluggable Solr/Elasticsearch/Lucene backend, plus RAG chat, pluggable rerankers, and AI agents. Self-hostable, Apache-2.0.
