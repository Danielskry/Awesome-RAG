...
- [AgenticMind](https://github.com/Moai-Team-LLC/AgenticMind): Self-hosted, auditable knowledge & memory layer for AI agents over MCP — citation-enforced answers (no source, no claim), a replayable why-trace per answer, hybrid (vector + BM25) retrieval on Postgres, and a judge-gated compounding loop. Apache-2.0.
