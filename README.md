...
- [PickySteve](https://github.com/KernelLord/pickysteve): Skill router and context picker for coding agents that uses hybrid BM25 + embedding retrieval (RRF-fused), cross-encoder reranking, and an LLM judge to assemble minimal, prompt-injection-screened context bundles.
